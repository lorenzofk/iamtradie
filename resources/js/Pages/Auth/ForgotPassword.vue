      ...
      <div class="relative z-10 flex flex-col justify-center items-start p-12 text-white">
        <div class="max-w-lg">
          ...
          <h1 class="text-4xl font-black mb-6 leading-tight">
            Secure Account
            <span class="bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent">Recovery</span>
          </h1>
          ...
          <div class="space-y-4 mb-8">
            <div class="flex items-center">
              ...
              <p class="text-blue-100 text-lg">Secure password reset process</p>
            </div>
            <div class="flex items-center">
              <div class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                <font-awesome-icon :icon="['fas', 'fa-envelope']" class="text-white text-sm" />
              </div>
              <p class="text-blue-100 text-lg">Reset link sent to your email</p>
            </div>
            <div class="flex items-center">
              <div class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                <font-awesome-icon :icon="['fas', 'fa-clock']" class="text-white text-sm" />
              </div>
              <p class="text-blue-100 text-lg">Back to work in minutes</p>
            </div>
          </div>
          ...
          <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <div class="flex items-center mb-4">
              ...
              <div>
                ...
                <p class="text-blue-200 text-sm">Cleaner, Melbourne</p>
              </div>
              <div class="ml-auto">
            ...
            <p class="text-blue-100 italic leading-relaxed">
              "Quick password reset got me back to managing quotes instantly. The security features give me peace of
              mind for my business."
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full max-w-md">
        ...
        >
          ...
          <div class="text-center mb-6">
            <div
              class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl mb-4 shadow-lg"
            >
              <font-awesome-icon :icon="['fas', 'fa-key']" class="text-white text-2xl" />
            </div>
            <h2 class="text-3xl font-black text-gray-900 mb-2">Forgot your password?</h2>
          ...
          <form @submit.prevent="onFormSubmit" class="space-y-5">
            ...
            >
              <div class="flex items-center justify-center">
                ...
                <font-awesome-icon v-else :icon="['fas', 'fa-paper-plane']" class="mr-3" />
                Send reset link
              </div>
            </Button>
