        ...
        <div class="space-y-2 lg:space-y-3">
          ...
          <div class="flex items-start gap-3 text-sm">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
              ...
              <span class="text-gray-900 font-medium text-sm">{{ new Date(quote.created_at).toLocaleString('en-AU') }}</span>
            </div>
          </div>
          ...
          <div v-if="quote.sent_at" class="flex items-start gap-3 text-sm">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
              ...
              <span class="text-gray-900 font-medium text-sm">{{ new Date(quote.sent_at).toLocaleString('en-AU') }}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="space-y-4 lg:space-y-6">
          ...
          <div>
            ...
            <div v-if="!isEditing" class="bg-blue-50 rounded-2xl rounded-tr-sm p-3 lg:p-4 border border-blue-100">
              <p class="text-gray-700 leading-relaxed whitespace-pre-line text-sm lg:text-base">{{ currentResponse }}</p>
            </div>
