        ...
        <template #header>
          <div class="text-center pt-6">
            ...
            <div class="text-3xl font-bold text-blue-600">
              ${{ modelValue.settings.callout_fee }}
            </div>
          </div>
        </template>
        <template #content>
    ...
    <div class="bg-blue-50 p-6 rounded-xl">
      ...
      <div class="bg-white p-4 rounded-lg border">
        <p class="text-sm text-gray-700">
          <strong>Sample quote:</strong> "Hi! For your electrical repair, it's ${{ modelValue.settings.callout_fee }} callout + 
          ${{ modelValue.settings.hourly_rate }}/hour for labor. Estimated total: ${{ modelValue.settings.callout_fee + modelValue.settings.hourly_rate * 2 }}-
          ${{ modelValue.settings.callout_fee + modelValue.settings.hourly_rate * 4 }} (2-4 hours work). When works best for you?"
        </p>
      </div>
    </div>
  </div>
