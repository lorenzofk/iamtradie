...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="inline-flex bg-white/15 backdrop-blur-sm rounded-2xl p-1.5 sm:p-2 gap-1 sm:gap-2">
        <button
          ...
          :class="[
            ...
            activeTab === 'sms' ? 'bg-white text-blue-600 shadow-lg' : 'text-white hover:bg-white/20',
          ]"
        >
        ...
        <button
          ...
          :class="[
            'px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold transition-all duration-300 flex items-center cursor-pointer text-sm sm:text-base',
            activeTab === 'call' ? 'bg-white text-blue-600 shadow-lg' : 'text-white hover:bg-white/20',
          ]"
        >
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
      ...
      <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl">
        <div class="text-center mb-6 sm:mb-8">
          <div
            class="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-sky-600 rounded-2xl mb-3 sm:mb-4 shadow-lg"
          >
            <font-awesome-icon :icon="['fas', scenarios[activeTab].icon]" class="text-lg sm:text-2xl text-white" />
          </div>
          <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{{ scenarios[activeTab].title }} Scenario</h3>
          ...
          >
            <div class="flex items-start gap-4 sm:gap-6">
              ...
              <div class="min-w-0 flex-1 pt-1">
                <h4
                  class="text-base sm:text-lg font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-gray-800 transition-colors duration-300"
                >
                  {{ story.time }}
                </h4>
                <p
                  class="text-sm sm:text-base text-gray-700 leading-relaxed group-hover:text-gray-600 transition-colors duration-300"
                >
                  {{ story.message }}
                </p>
              </div>
            ...
            <div
              class="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500/5 to-sky-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
            ></div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl">
        <div class="text-center mb-6 sm:mb-8">
          <div
            class="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl mb-3 sm:mb-4 shadow-lg"
          >
        ...
        <div class="space-y-3 sm:space-y-4">
          <div
            class="flex justify-between items-center p-3 sm:p-4 bg-blue-50 rounded-xl border-l-4 border-blue-400 hover:shadow-md transition-all duration-300 hover:bg-blue-100"
          >
          ...
          <div
            class="flex justify-between items-center p-3 sm:p-4 bg-orange-50 rounded-xl border-l-4 border-orange-400 hover:shadow-md transition-all duration-300 hover:bg-orange-100"
          >
          ...
          <div
            class="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-xl border-l-4 border-gray-300 hover:shadow-md transition-all duration-300 hover:bg-gray-100"
          >
          ...
          <div
            class="flex justify-between items-center p-3 sm:p-4 bg-red-50 rounded-xl border-l-4 border-red-400 hover:shadow-md transition-all duration-300 hover:bg-red-100"
          >
        ...
        <!-- Bottom Call-out -->
        <div
          class="mt-6 sm:mt-8 p-4 sm:p-6 bg-gradient-to-r from-red-500 to-pink-600 rounded-2xl text-center text-white hover:shadow-xl transition-shadow duration-300"
        >
    ...
    <div class="mt-12 sm:mt-16 text-center">
      <div
        class="bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-white/30 shadow-2xl"
      >
        <div class="flex items-center justify-center gap-2 sm:gap-4 mb-6">
          <div
            class="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-green-400 to-blue-500 rounded-2xl shadow-lg"
          >
        ...
        <h4 class="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6">PingMate Solves Both Problems Instantly</h4>
        <p class="text-base sm:text-lg lg:text-xl text-green-100 leading-relaxed max-w-3xl mx-auto">
          Whether customers text or call, PingMate responds professionally in seconds. Never lose another $500 job to
          slow communication again.
        </p>
      </div>
    </div>
  </div>
