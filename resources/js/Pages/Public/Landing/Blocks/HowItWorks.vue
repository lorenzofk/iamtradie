...
const startWorkflowAnimation = () => {
  ...
  const steps = [
    ...
    () => {
      showCallSummary.value = true;
    }, // Summary to you
    () => {
      showAutoReply.value = true;
...
const smsExamples = [
  {
    ...
    aiResponse:
      "G'day! Power point install typically $380-$520 incl. callout. Takes 2-3 hours. Happy to give you a proper quote! Cheers, Dave.",
  ...
  },
  {
    ...
    aiResponse:
      'No worries mate! Hot water repairs $420-$680 incl. callout. Can come out tonight if urgent. Give us a bell! - Mike',
  ...
  },
  {
    ...
    aiResponse:
      'Hi there! 3BR bond clean typically $680-$950. Includes all rooms, kitchen, bathrooms. Guaranteed to pass inspection! - Sarah',
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center mb-12 sm:mb-16">
      ...
      <p class="text-base sm:text-lg lg:text-xl text-slate-600 max-w-4xl mx-auto">
        Customer texts you at 8:30 PM? AI replies instantly with a professional quote using your rates. Weekend inquiry?
        No worries, you're always first to respond.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-16 sm:mb-20">
      ...
      >
        <div class="text-center mb-4 sm:mb-6">
          <div
            class="bg-sky-100 rounded-full w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center mx-auto mb-2 sm:mb-3"
          >
          ...
          <div class="flex justify-start">
            <div class="bg-gray-200 rounded-2xl rounded-bl-md px-2 sm:px-3 py-1.5 sm:py-2 max-w-[85%] sm:max-w-xs">
              ...
              <div class="text-xs text-gray-500 mt-1">
                {{ index === 0 ? '2:15 PM' : index === 1 ? '9:22 PM' : '4:45 PM' }}
              </div>
            </div>
          </div>
          ...
          <div class="flex justify-end">
            <div class="bg-gray-300 rounded-2xl rounded-br-md px-3 sm:px-4 py-1.5 sm:py-2">
              <div class="flex space-x-1">
                ...
                <div
                  class="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-600 rounded-full animate-bounce"
    ...
    <div class="text-center mb-12 sm:mb-16">
      ...
      <p class="text-base sm:text-lg lg:text-xl text-slate-600 max-w-4xl mx-auto mb-6 sm:mb-8">
        Never miss another opportunity. When customers call and you can't answer, AI handles everything — transcribes
        voicemails, sends you smart summaries, and optionally replies to customers with professional quotes.
      </p>
    ...
    <div class="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 lg:p-12 shadow-2xl border border-sky-100 mb-16 sm:mb-20">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
        ...
        <div class="space-y-4 sm:space-y-6">
          ...
          <div
            class="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 rounded-xl transition-all duration-300"
            :class="
              currentStep >= 1 ? 'bg-sky-50 border-2 border-sky-200 shadow-md' : 'bg-gray-50 border-2 border-gray-200'
            "
          >
            <div
              class="w-10 h-10 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-colors duration-300 flex-shrink-0"
          ...
          <div
            class="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 rounded-xl transition-all duration-300"
            :class="
              currentStep >= 2 ? 'bg-blue-50 border-2 border-blue-200 shadow-md' : 'bg-gray-50 border-2 border-gray-200'
            "
          >
            <div
              class="w-10 h-10 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-colors duration-300 flex-shrink-0"
            ...
            <div class="min-w-0 flex-1">
              ...
              <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                ...
                <span
                  class="text-xs px-2 sm:px-3 py-1 bg-blue-100 text-blue-600 rounded-full font-medium self-start sm:self-auto"
                >
                  Optional
                </span>
              </div>
        ...
        <div class="space-y-6 sm:space-y-8">
          <!-- Summary to You -->
          <div
            class="bg-gradient-to-br from-white to-sky-50 rounded-xl sm:rounded-2xl border-2 p-4 sm:p-6 lg:p-8 transition-all duration-500 shadow-lg"
            :class="showCallSummary ? 'border-sky-200 shadow-2xl scale-105' : 'border-gray-200 opacity-50'"
          >
            <div class="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div
                class="bg-sky-100 rounded-full w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center shadow-md flex-shrink-0"
              >
            ...
            <div class="bg-white rounded-xl p-3 sm:p-4 shadow-sm" v-show="showCallSummary">
              <div class="flex justify-end">
                <div class="bg-blue-500 rounded-2xl rounded-br-md px-3 sm:px-4 py-2 sm:py-3 max-w-[90%] sm:max-w-sm">
                  <p class="text-xs sm:text-sm text-white leading-relaxed">
                    📞 Missed Call from 0482 123 456
                    <br />
                    💬 Fuse box tripping — wants someone this week
                    <br />
                    💰 Est. Value: $320–$450
                    <br />
                    ⚡ Urgency: Medium
              ...
              <div class="flex justify-center mt-3 sm:mt-4">
                <span
                  class="bg-green-100 text-green-800 px-3 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold"
                >
          ...
          <!-- Auto-Reply to Customer -->
          <div
            class="bg-gradient-to-br from-white to-green-50 rounded-xl sm:rounded-2xl border-2 p-4 sm:p-6 lg:p-8 transition-all duration-500 shadow-lg"
            :class="showAutoReply ? 'border-green-200 shadow-2xl scale-105' : 'border-gray-200 opacity-50'"
          >
            <div class="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div
                class="bg-green-100 rounded-full w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center shadow-md flex-shrink-0"
              >
              ...
              <div class="min-w-0 flex-1">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                  ...
                  <span
                    class="text-xs px-2 sm:px-3 py-1 bg-green-100 text-green-600 rounded-full font-medium self-start sm:self-auto"
                  >
                    Optional
                  </span>
                </div>
            ...
            <div class="bg-white rounded-xl p-3 sm:p-4 shadow-sm" v-show="showAutoReply">
              <div class="flex justify-end">
                <div class="bg-blue-500 rounded-2xl rounded-br-md px-3 sm:px-4 py-2 sm:py-3 max-w-[90%] sm:max-w-sm">
                  <p class="text-xs sm:text-sm text-white leading-relaxed">
                    Thanks for calling! Fuse box issues typically $320-450 incl. callout. I'll check your message and
                    get back shortly. If urgent, reply here. - Dave
                  </p>
                  <div class="text-xs text-blue-200 mt-2 flex items-center justify-end">
                    <span>10:19 AM</span>
                    <div class="ml-1 text-white">✓✓</div>
