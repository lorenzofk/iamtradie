...
return [
    ...
    */
    ...
    'middleware' => [
        'web',
        \App\Http\Middleware\EnsureUserCanViewLogs::class,
    ],
    ...
    */
    ...
    'include_files' => [
        ...
        // Production: Only include Laravel application logs for security
        // Commented out system logs to prevent exposing sensitive server information
        // '/var/log/httpd/*' => 'Apache',
        // '/var/log/nginx/*' => 'Nginx',

        // MacOS Apple Silicon logs (only for local development)
